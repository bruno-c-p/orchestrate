...
- `senior_critic` — `gpt-5.6-terra`, reasoning `xhigh` — senior-review leaf
```
...
### Senior critic — Terra high or xhigh
...
- **Analytics or payments:** use separate Luna xhigh scouts for independent sources when useful, then Luna max to reconcile definitions and mismatches; use Terra high or xhigh for money-sensitive ambiguity.
...
- **Consulting or research:** use Luna xhigh for source collection, Luna max for evidence normalization, and Terra high or the root for the recommendation and tradeoffs.
...
7. Whether the worker is a leaf or an explicitly authorized Terra coordinator. Luna is always a leaf.
